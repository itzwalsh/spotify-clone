    ...
    return (
        <div className="flex-grow h-screen overflow-y-scroll scrollbar-hide">
            ...
            <section className={`flex items-end space-x-7 bg-gradient-to-b to-black ${color} h-80 text-white padding-8`}>
                <img className="h-44 w-44 shadow-2xl mb-3 ml-2" src={playlist?.images?.[0]?.url} alt=""/>

                <div>
                    <p className="mb-3">PLAYLIST</p>
                    <h1 className="text-2xl md:text-3xl xl:text-5xl font-bold mb-6">{playlist?.name}</h1>
                </div>
            </section>
